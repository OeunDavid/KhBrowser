...
namespace ToolLib
{
    ...
    {
         ExecutionResult execute(params string[] p);
    ...
    public class AdbCommand:IAdbCommand
    {
        ...
        public static readonly string PATH = System.Environment.CurrentDirectory+ @"/tool/adb.exe";
        public static readonly string CUR_DIR = DeviceInfo.SCREEN_PATH;
        const int RETRY = 1;
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        
        public  ExecutionResult execute(params string[] p)
        {

            return execute(CUR_DIR, p);
        }
